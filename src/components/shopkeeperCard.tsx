...
const ShopkeeperCard: React.FC<ShopkeeperCardProps> = ({
  ...
  return (
    <div className="shopkeeper-card rounded-md shadow-md mb-6 bg-stone-100 dark:bg-gray-700">
      {/* Collapsed View */}
      {isCollapsed ? (
        <div className="relative">
          <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
          <h2 className="text-2xl font-bold text-stone-600 dark:text-gray-300 cinzel shopkeeper-name m-0">
              {shopkeeper.shopName}
            </h2>
            <div className="flex items-center flex-wrap">
            <span className="material-symbols-outlined mr-1 text-stone-400 leading-none">person_raised_hand</span>
          ...
          <div className="flex items-center gap-2">
              ...
              className="p-2 hover:bg-stone-200 dark:hover:bg-gray-600 rounded-lg transition-colors"
              title="Expand details"
            >
              <span className="material-symbols-outlined text-stone-600 dark:text-gray-400">
                expand_more
              </span>
            </button>
          </div>
                        ...
                        return (
                          <li key="standard">
                            <button
                              onClick={() => {
                                closeAllDropdowns();
                                const standardIndex = pricingStyles.findIndex(
                                  (s) => s.modifier === 0
                                );
                                setSelectedPricingStyle(
                                  standardIndex.toString()
                                );
                                setIsDropdownOpen(false);

                                const standardPricingStyle =
                                  pricingStyles.find(
                                    (style) => style.modifier === 0
                                  ) || pricingStyles[0];
                                const newPriceModifier =
                                  standardPricingStyle.modifier;
                                ...
                                const shopDescriptionData =
                                  generateShopDescription(
                                    ...
                                    {
                                      location:
                                        shopkeeper.shopDescriptionParts
                                          .location,
                                    }
                                  );
                                ...
                                const adjustedCommonItems =
                                  shopkeeper.commonItems.map((item) => ({
                                    ...item,
                                    adjustedPrice: adjustPrice(
                                      item.basePrice,
                                      newPriceModifier
                                    ),
                                  }));

                                const adjustedRareItems =
                                  shopkeeper.rareItems.map((item) => ({
                                    ...item,
                                    adjustedPrice: adjustPrice(
                                      item.basePrice,
                                      newPriceModifier
                        ...
                        <li key={style.modifier}>
                          <button
                            onClick={() => {
                              ...
                              const styleIndex = pricingStyles.findIndex(
                                (s) => s.modifier === style.modifier
                              );
        ...
        // Expanded View - Your original content
        <div className="p-0">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
            <h2 className="text-2xl font-bold text-stone-600 dark:text-gray-300 cinzel shopkeeper-name m-0">
              ...
              <div className="relative inline-block">
                ...
                >
                  <span className="flex items-center">
                    {(() => {
                      const icon =
                        shopIcons[shopkeeper.shopType] || "storefront";
          ...
          <div className="text-stone-600 dark:text-gray-300 inter text-sm mt-1">
            ...
            <div className="text-stone-600 dark:text-gray-300 inter text-sm leading-relaxed">
              ...
              <span>
                {" "}
                market rate for{" "}
                {getShopkeeperPronouns(shopkeeper.name).possessive} wares.
              </span>
            </div>
          </div>
        </div>
